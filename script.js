...
function printBackend(backendData) {
    ...
    // pokemonAbilities.innerHTML = "";
            ...
            deleteBtn.addEventListener("click", () => {
                ...
                fetch("http://localhost:8080/pokemon?pokemonId=" + pokemonId.pokemonId, {
                    method: "DELETE"
                })
                .then(res => res.json())
                .then(data => {
                ...
                //printBackend(backendList);
                
            })
            //fetchBackend(backendPokiedexUrl);
            pokemonList.append(li, deleteBtn, p);
        })
...
function printPokemonInfo(pokemonData) {
    ...
    pokemonDiv.append(pokemonName, pokemonSprite, pokemonWeight, pokemonHeight, addToPokiedexBtn, inputNotice);
